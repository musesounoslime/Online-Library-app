            ...
            <div className='mt-3'>
                <nav>
                    <div className='nav nav-tabs' id='nav-tab' role='tablist'>
                        <button onClick={() => {setHistoryClick(false); setLoansClick(true)}} className='nav-link active' id='nav-loans-tab' data-bs-toggle='tab'
                            data-bs-target='#nav-loans' type='button' role='tab' aria-controls='nav-loans'
                            aria-selected='true'>
                                Loans
                        </button>
                        <button onClick={() => {setHistoryClick(true); setLoansClick(false)}} className='nav-link' id='nav-history-tab' data-bs-toggle='tab'
